<template>
    <f7-page style="background: white" color-theme="green">
        <div
                v-if="!loaded"
        ...
        <div class="stats" v-if="loaded">
            ...
            <div class="stats-section">
                <div class="stats-section-title">Food additives</div>
                <div class="stats-row" v-for="item in other">
                    <div @click="openListE(item)">
            <span class="stats-label" :style="`background-color: #4cd964`">{{
              item.name
            }}</span>
                    </div>
                    <div class="stats-number" :style="`border-color: #4cd964`">
                        {{ item.count }}
                    </div>
                </div>
            </div>
